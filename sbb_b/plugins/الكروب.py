...
@sbb_b.on(admin_cmd(pattern=r"المحظورين?(.*)"))
...
@sbb_b.on(admin_cmd(pattern="تشفير الملف ?(.*)"))
async def pyZip(e):
    if e.fwd_from:
        return
    ...
    zip_ = f"{nem_}.zip" if nem_ else "sbb_b_Zip.zip"
    password = pass_ if pass_ else "sbb_b"
    ...
    try:
        ...
        os.remove(zip_)
        os.remove(dl_)
@sbb_b.on(admin_cmd(pattern=f"{MUTE}(?:\s|$)([\s\S]*)"))
...
@sbb_b.on(admin_cmd(pattern=f"{UNMUTE}(?:\s|$)([\s\S]*)"))
...
@sbb_b.on(admin_cmd(pattern=r"المشرفين(?: |$)(.*)"))
async def _(event):
...
@sbb_b.on(admin_cmd(pattern=r"البوتات?(.*)"))
async def _(event):
...
@sbb_b.on(admin_cmd(pattern=r"الأعضاء(?: |$)(.*)"))
...
@sbb_b.on(admin_cmd(pattern=r"معلومات(?: |$)(.*)"))
...
@sbb_b.on(admin_cmd(pattern=f"{addition} ?(.*)"))
async def iq(event):
    ...
    sbb_b = await get_chatinfo(event)
    ...
    async for user in event.client.iter_participants(sbb_b.full_chat.id):
        try:
...
@sbb_b.on(admin_cmd(pattern=f"{TFLASH}(.*)"))
async def _(event):
    ...
    sbb_bevent = await edit_or_reply(event, "**☭ ⦙  جاري تفليش مجموعتك أنتظر قليلآ 🚮**")
    ...
    async for user in event.client.iter_participants(event.chat_id):
        ...
        try:
            ...
            LOGS.info(str(e))
    await sbb_bevent.edit(f"**☭ ⦙   تم بنجاح تفليش مجموعتك من {total} الاعضاء 🚮**")
...
@sbb_b.on(admin_cmd(pattern=f"{LEFT}(.*)"))
async def kickme(leave):
    await leave.edit("**☭ ⦙   جـاري مـغادرة المجـموعة مـع السـلامة  🚶‍♂️  ..**")
    await leave.client.kick_participant(leave.chat_id, "me")

@sbb_b.on(admin_cmd(pattern=f"{REMOVEBAN}(.*)"))
async def _(event):
...
@sbb_b.on(admin_cmd(pattern=f"المحذوفين ?([\s\S]*)"))
...
@sbb_b.on(admin_cmd(pattern=r"احصائيات الاعضاء ?([\s\S]*)"))
...
@sbb_b.on(admin_cmd(pattern="تقيد(?:\s|$)([\s\S]*)",))
...
@sbb_b.iq_cmd(pattern="اكتم(?:\s|$)([\s\S]*)",)
...
@sbb_b.on(admin_cmd(pattern=r"احظر(?:\s|$)([\s\S]*)",))
...
@sbb_b.on(admin_cmd(pattern=r"حظر عام(?:\s|$)([\s\S]*)",))
...
@sbb_b.on(admin_cmd(pattern=r"الغاء حظر العام(?:\s|$)([\s\S]*)",))
...
@sbb_b.on(admin_cmd(pattern=r"المحظورين عام$",))
async def gablist(event):
    gbanned_users = gban_sql.get_all_gbanned()
    GBANNED_LIST = "Current Gbanned Users\n"
    if len(gbanned_users) > 0:
...
@sbb_b.on(admin_cmd(pattern=r"معلومات تخزين المجموعه(?:\s|$)([\s\S]*)"))
async def _(event):  # sourcery no-metrics
    reply = await event.get_reply_message()
    input_str = event.pattern_match.group(1)
...
@sbb_b.iq_cmd(incoming=True, func=lambda e: e.is_private, edited=False, forword=None)
...
@sbb_b.iq_cmd(incoming=True, func=lambda e: e.mentioned, edited=False, forword=None)
...
@sbb_b.on(admin_cmd(pattern=r"تخزين الخاص (تشغيل|ايقاف)$"))
...
@sbb_b.on(admin_cmd(pattern=r"تخزين الكروبات (تشغيل|ايقاف)$"))
...
@sbb_b.on(admin_cmd(pattern=f"{LINKK} ?(.*)"))
async def iq(SLQ):
...
@sbb_b.on(admin_cmd(pattern="عدد رسائلي ?(.*)"))
async def iq(SLQ):
...
@sbb_b.on(admin_cmd(pattern="تغير صورة( المجموعة| -d)$"))
...
@sbb_b.on(admin_cmd(pattern=f"{ADMINRAISE}(?: |$)(.*)"))
...
@sbb_b.on(admin_cmd(pattern=f"{UNADMINRAISE}(?: |$)(.*)"))
...
@sbb_b.on(admin_cmd(pattern="تثبيت(?: |$)(.*)"))
async def pin(event):
    "☭ ⦙   تثبيت  📌"
...
@sbb_b.on(admin_cmd(pattern="الغاء التثبيت(?: |$)(.*)"))
async def pin(event):
...
@sbb_b.on(admin_cmd(pattern="جلب الاحداث(?: |$)(.*)"))
...
@sbb_b.on(admin_cmd(pattern=f"{BANDD}(?: |$)(.*)"))
...
@sbb_b.on(admin_cmd(pattern=r"zip(?:\s|$)([\s\S]*)"))
...
@sbb_b.on(admin_cmd(pattern=r"unzip(?:\s|$)([\s\S]*)"))
...
@sbb_b.on(admin_cmd(pattern="معرفه(?: |$)(.*)"))
...
@sbb_b.on(admin_cmd(pattern=f"{UNBANDD}(?: |$)(.*)"))
...
async def watcher(event):
    if is_muted(event.sender_id, event.chat_id):
        try:
            ...
            LOGS.info(str(e))
@sbb_b.on(admin_cmd(pattern="صنع (مجموعه|قناه) (.*)"))
async def iq(event):
...
@sbb_b.on(admin_cmd(pattern="تلقائي ?(.*)"))
async def _(event):
...
@sbb_b.on(admin_cmd(pattern="الغاء_التلقائي ?(.*)"))
async def _(event):
    if (event.is_private or event.is_group):
        return await edit_or_reply(event, "امر التلقائي يستخدم فقط للقنوات.")
    hel_ = event.pattern_match.group(1)
...
@sbb_b.on(admin_cmd(pattern=r"جلب الصور(?:\s|$)([\s\S]*)"))
async def potocmd(event):
    ...
    if uid.strip() == "":
        ...
        await event.client.send_file(event.chat_id, send_photos)
    await event.delete()
@sbb_b.on(admin_cmd(pattern="تفعيل ([\s\S]*)"))    
async def _(event):  
    input_str = event.pattern_match.group(1)
...
@sbb_b.on(admin_cmd(pattern="تعطيل ([\s\S]*)"))    
async def _(event):  
    input_str = event.pattern_match.group(1)
    peer_id = event.chat_id
    if not event.is_group:
...
@sbb_b.on(admin_cmd(pattern="صلاحيات المجموعه$"))    
async def _(event):  
    res = ""
