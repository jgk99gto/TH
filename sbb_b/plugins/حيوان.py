# ®
#الملـف حقـوق وكتابـة الهيبـه ⤶ خاص بسـورس ⤶
...
async def fetch_info(replied_user, event):
    ...
    if x == 1:
       ...
       caption += f"<b> 𓆩 ╼•✬• 𝐒𝐎𝐔𝐑𝐂𝐄 𝐒𝐏𝐈𝐃𝐄𝐑 ➪︎ @EE_20  •✬•╾ "
    ...
    if x == 3:
       ...
       caption += f"<b> • 🌚 | نسبتـه  ⇦  {yoy} </b>\n\n\n"
       caption += f"<b> 𓆩 ╼•✬• 𝐒𝐎𝐔𝐑𝐂𝐄 𝐒𝐏𝐈𝐃𝐄𝐑 ➪︎ @EE_20  •✬•╾ 𓆪  "
    ...
    if x == 8:
       ...
       caption += f"<b> • 🌚 | نسبتـه  ⇦  {yoy} </b>\n\n\n"
       caption += f"<b> 𓆩 ╼•✬• 𝐒𝐎𝐔𝐑𝐂𝐄 𝐒𝐏𝐈𝐃𝐄𝐑 ➪︎ @ZZZ7iZ  •✬•╾ 𓆪  "
...
async def who(event):
    ...
    if replied_user.id == 5012406813 or replied_user.id == 5012406813 or replied_user.id == 5680297831:
