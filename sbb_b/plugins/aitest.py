...
""" 
CC Checker & Generator for SPIDER™ t.me/ZZZ7iZ
Write file by t.me/H_M_Dr
hhh o ya beby
...
# code by t.me/sbb_b
@sbb_b.ar_cmd(pattern="os(?:\s|$)([\s\S]*)")
async def song2(event):
    song = event.pattern_match.group(1)
    chat = "@OpenAI_GPT_Chatbot" # code by t.me/sbb_b
    ...
    async with event.client.conversation(chat) as conv:
        try:
            ...
            await sbb_b(unblock("OpenAI_GPT_Chatbot"))
            gool = "{}".format(song)
            await conv.send_message(gool)
