...
async def hi(event):
    await edit_or_reply(
        event,
        "**قائـمه اوامـر الترفيه:**\n\n• جميع هذه الاوامـر تستخدم بالرد على الشخص\n ⟸ `.رفع مطي`\n ⟸ `.رفع كلب`\n ⟸ `.رفع حيوان`\n ⟸ `.رفع زاحف`\n ⟸ `.رفع مرتي`\n ⟸ `.رفع زوجي`\n ⟸ `.رفع تاج`\n ⟸ `.رفع بكلبي`\n ⟸ `.رفع بزون`\n ⟸ `.رفع قرد`\n\n ⟸ `.نسبة الحب`\n ⟸ `.نسبة الانوثة`\n ⟸ `.نسبة الرجولة`\n ⟸ `.نسبة الغباء`\n ⟸ `.نسبة المثْلية`\n\n ⟸ `.كت`\n ⟸ `.اوصف`\n ⟸ `.هينه`\n ⟸ `.نزوج`\n ⟸ `.طلاك`",
    )
