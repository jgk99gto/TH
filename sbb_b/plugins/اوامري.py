...
ROE = """** اهلا بك عزيزي المستخدم في قائمة اوامر الخليفه 
...
اوامر فارات سورس الخليفه @ZZZ7iZ""",
        buttons=[
...
async def varssett(event):
    await event.edit(
        """اهلا بك في قائمة اوامر سورس الخليفه هذه بعض المعلومات عن الخليفه :

- سورس الخليفه يمتلك اكثر من 100 أمر 
- الخليفه هو افضل سورس عربي يتميز بالحماية

قـنـاة الـسـورس : @ZZZ7iZ

مـطـور الـسـورس : @H_M_Dr""",
        buttons=[
            [Button.inline("رجوع", data="namevar")],
        ],
    )
...
* يمكنك الحصول على  كليشة جاهزة من هذه القناة @ZZZ7iZ
ملاحظة : يمكنك استخدام الاوامر في اي دردشة او محادثة
اوامر فارات سورس الخليفه @ZZZ7iZ""",
        buttons=[
            [Button.inline("رجوع", data="pmvars")],
