    ...
    if chat.id != Config.OWNER_ID:
        ...
        if customstrmsg is not None:
            ...
            start_msg = f"اهلا 👤{mention},\
                        ...
                        \nيمكنك التواصل معي من خلال هذا البوت"
        buttons = [
            (
                Button.url("𓏺 ѕᴏᴜʀᴄᴇ ᴄᴀʟɪᴘʜ", "https://t.me/ZZZ7iZ"),
                Button.url(
                    "• 𝗖𝗔𝗟𝗜𝗣𝗛  ›",
                    "https://t.me/H_M_Dr",
                ),
        ...
        buttons = [
            [
                Button.url("• السورس •", "https://t.me/ZZZ7iZ"),
            ],
            [
